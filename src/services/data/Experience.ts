  ...
  experience: [
    {
      ...
      title: 'Web Programmer (Front-end / Back-end and UX Develop)',
      subtitle: 'Nipa Technology Company Limited. (นิภา เทคโนโลยี)',
      description:
        'Develop and design user interface (UI) about cloud computing website (NCP) via Openstack API service with Vue.js Framework (Front-end), Node.js (Back-end).',
    ...
    },
    {
      ...
      description: 'Teacher Assistance (TA) about JAVA SE.'
    },
    {
      id: 'year_2015',
    ...
    },
    {
      ...
      description: 'Field of Core Network.'
    },
    {
      id: 'year_2013',
